...
import { OtolithVisualization } from '@/components/dashboard/otolith-visualization';
import {
  Select,
  SelectContent,
  SelectItem,
          ...
          <main className="p-4 md:p-6 lg:p-8">
            <div className="grid auto-rows-max items-start gap-6">
                <div className="flex items-center gap-4">
                    <h1 className="text-2xl font-bold">Otolith Visualization</h1>
